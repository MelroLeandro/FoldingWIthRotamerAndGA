##
# Extract 1º base and dihedral angles
#
#    CLeandro 2014
#
#
...
#
# It assumes the input file pdb is in the current directory,
# and generates two output files tsv in the current directory
#
#.
